...
const features = [
  { label: 'Artisan profiles', icon: UserRound },
  { label: 'Service booking', icon: BriefcaseBusiness },
  { label: 'Customer dashboard', icon: LayoutDashboard },
  { label: 'Artisan dashboard', icon: LayoutDashboard },
  { label: 'Messaging', icon: MessageSquare },
  { label: 'Job management', icon: CheckCircle2 },
...
const challenges = [
  'Building booking workflows that feel simple for customers while remaining practical for artisans.',
  'Managing user roles across customers, artisans, and admin-style product flows.',
  'Structuring dashboard architecture so each user type has clear actions and useful status visibility.',
  'Maintaining mobile responsiveness across marketplace browsing, profiles, bookings, and dashboards.',
];

const lessons = [
  'Product thinking matters as much as code when turning service problems into useful workflows.',
  'User experience decisions shape trust, especially in local service marketplaces.',
  'Database design needs to reflect real user roles, booking states, reviews, and future payments.',
  'Scalable architecture starts with clear boundaries between discovery, booking, messaging, and management.',
];
    ...
    <main id="main-content" className="bg-[#05050A] text-white">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-center">
            ...
            >
              ...
              >
                Connecting customers with trusted artisans through technology.
              </motion.p>
            </motion.div>
                ...
                <div className="flex h-full flex-col justify-between rounded-xl border border-white/10 bg-black/30 p-5">
                  <div>
                    ...
                    <div className="mt-5 grid gap-3">
                      ...
                      <div className="h-24 rounded-xl border border-cyan-300/15 bg-cyan-300/[0.04]" />
                    </div>
                  </div>
      ...
      <section className="border-t border-white/10 px-6 py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-2">
          <GlassCard>
            <SectionHeader label="Problem" title="Trust and visibility are the core gaps." />
            <p className="mt-6 text-base leading-8 text-white/70">
              Finding trusted artisans is difficult. Customers often rely on word of mouth, limited
              referrals, or uncertain service quality when they need skilled help.
            </p>
            <p className="mt-4 text-base leading-8 text-white/70">
              Artisans also struggle to get visibility and consistent jobs, even when they have the
              skills and experience to deliver good work.
            </p>
          </GlassCard>

          <GlassCard>
            <SectionHeader label="Solution" title="A marketplace built around service discovery." />
            <p className="mt-6 text-base leading-8 text-white/70">
              Handiwave creates a digital marketplace connecting customers and artisans through
              profiles, bookings, reviews, messaging, and service discovery.
            </p>
            <p className="mt-4 text-base leading-8 text-white/70">
              The goal is to make local services easier to find, compare, request, and manage from a
      ...
      <section className="border-t border-white/10 px-6 py-20 sm:py-24">
        <div className="mx-auto max-w-6xl">
          <SectionHeader label="Screenshots" title="Interface placeholders for the product flow." />
          <div className="mt-10 grid gap-5 lg:grid-cols-3">
            {['Marketplace discovery', 'Customer dashboard', 'Artisan dashboard'].map((screen) => (
              <div
                key={screen}
      ...
      <section className="border-t border-white/10 px-6 py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <GlassCard>
            <SectionHeader label="Tech Stack" title="Tools used to shape the product." />
      ...
      <section className="border-t border-white/10 px-6 py-20 sm:py-24">
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-2">
          <GlassCard>
            <SectionHeader label="Lessons Learned" title="What Handiwave strengthened." />
            <ul className="mt-8 space-y-4">
              {lessons.map((lesson) => (
          ...
          <GlassCard>
            <SectionHeader label="Future Roadmap" title="Where the product can grow next." />
...
export default HandiwaveCaseStudy;
